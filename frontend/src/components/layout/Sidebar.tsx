...
import { LayoutDashboard, ScrollText, ShieldCheck, Cpu, PieChart } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
    ...
    return (
        <aside className="w-64 border-r border-border/50 bg-card/40 backdrop-blur-2xl flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
